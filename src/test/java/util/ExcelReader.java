...
//	public static String filename = System.getProperty("user.dir")+"\\src\\config\\testcases\\DataTable.xlsx";
	public  String path;
	...
	public boolean setHeaderCell(String sheetName, int colNum, String data){
		int rowNum = 1;
		try{
		fis = new FileInputStream(path); 
		workbook = new XSSFWorkbook(fis);
  ...
  // find whether sheets exists	
	...
	public static void main(String arg[]) throws IOException{
		...
		DataTable = new ExcelReader(System.getProperty("user.dir")+"\\src\\test\\java\\config\\DataTable.xlsx");
			 System.out.println(DataTable.getCellData("TestSignIn", "UserName", 2));
